...
export function servaBlueslickDetailFixture(): CatalogProductDetailResponseUi {
  return {
    ...
    product: {
      ...
      commercial_history: [
        {
          history_key: "serva-blueslick-250ml:ceaf-serva:client:product",
          ...
          total_price_decimal: null,
          margin_status: "needs_review",
          deal_status: "paid_by_client__supplier_payment_sent__logistics_pending",
          is_public_safe: false,
          source_summary: "Cotización CEAF / negocio confirmado",
          confidence: "operator_confirmed",
        },
        {
          history_key: "serva-blueslick-250ml:ceaf-serva:supplier:product",
          deal_key: "serva-ceaf-oc-26172-po-174-26",
          deal_label: "CEAF × SERVA",
          client_org_name: "CEAF",
          supplier_org_name: "SERVA Electrophoresis GmbH",
          ...
          amount_minor: 11700,
          unit_price_decimal: "117.00",
          total_price_decimal: "117.00",
          margin_status: "needs_review",
          deal_status: "paid_by_client__supplier_payment_sent__logistics_pending",
          is_public_safe: false,
          source_summary: "SERVA proforma / CEAF deal",
          confidence: "operator_confirmed",
        },
      ],
    },
...
export function servaTemedDetailFixture(): CatalogProductDetailResponseUi {
  const base = servaBlueslickDetailFixture();
  ...
  return {
    ...
    product: {
      ...
      manufacturer_name: "SERVA Electrophoresis GmbH",
      default_unit: "ea",
      website_slug: "temed-25ml",
      website_product_id: "serva-temed-25ml",
      is_active: true,
      aliases: [{ alias_source: "serva", alias_code: "3593002", alias_kind: "sku" }],
      ...
      commercial_links: [
        {
          link_kind: "commercial_deal_line",
          link_ref: "deal:serva-ceaf-oc-26172-po-174-26:line:2",
          confidence: "operator_confirmed",
        },
        { link_kind: "website_product", link_ref: "web:temed-25ml", confidence: "website_editorial" },
      ],
      commercial_history: [
        {
          history_key: "serva-temed-25ml:ceaf-serva:client:product",
          deal_key: "serva-ceaf-oc-26172-po-174-26",
          deal_label: "CEAF × SERVA",
          client_org_name: "CEAF",
          supplier_org_name: "SERVA Electrophoresis GmbH",
        ...
        {
          history_key: "serva-temed-25ml:ceaf-serva:supplier:product",
          deal_key: "serva-ceaf-oc-26172-po-174-26",
          deal_label: "CEAF × SERVA",
          client_org_name: "CEAF",
          supplier_org_name: "SERVA Electrophoresis GmbH",
          ...
          amount_minor: 3100,
          unit_price_decimal: "31.00",
          total_price_decimal: "31.00",
          margin_status: "needs_review",
          deal_status: "paid_by_client__supplier_payment_sent__logistics_pending",
          is_public_safe: false,
          source_summary: "SERVA proforma / CEAF deal",
