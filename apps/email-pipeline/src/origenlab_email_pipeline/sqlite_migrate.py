...
def migrate_sqlite_schema(
    ...
    *,
    ...
    Order:
        ...
        2. ensure_leads_tables (refresh_view=False)
        3. ensure_lead_account_tables (refresh_view=False)
        4. refresh_lead_match_summary_view once if leads or accounts layer ran
