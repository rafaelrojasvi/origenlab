"""Read-only helpers for Streamlit «Leads y cuentas»: operators browse pipeline + archive linkage.
...
Writes to enrichment are done only from the app when ``ORIGENLAB_STREAMLIT_LEADS_REVIEW_RW=1``.
"""
