...
| `scripts/leads/advanced/export_leads_spanish_csvs.py` | parked_legacy | Owner review — Spanish `_es` CSV helper | CSV inputs | `reports/out` `*_es.csv` | low | See [`REDUCTION_SHORTLIST_20260607.md`](audits/REDUCTION_SHORTLIST_20260607.md#owner-review-zero-ref-advanced-helpers-pr-124) | **Not** daily outbound; **`--export` = input path**; not send approval |
...
| `scripts/leads/advanced/export_leads_spanish_csvs.py` | CONSOLIDATE / parked | Spanish `_es` CSV helper — **owner review** ([#124 shortlist](audits/REDUCTION_SHORTLIST_20260607.md#owner-review-zero-ref-advanced-helpers-pr-124)); not daily ops |
