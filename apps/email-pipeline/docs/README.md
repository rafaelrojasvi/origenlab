...
- [`RUNBOOK.md`](RUNBOOK.md#m-eprun-path)
- [`DATA_LOCATIONS.md`](DATA_LOCATIONS.md#m-epdata-root)
- [`REPORTING.md`](REPORTING.md#m-eprep-mail) (+ [`REPORT_SCOPE_CLIENT.md`](REPORT_SCOPE_CLIENT.md) para el texto de alcance que se adjunta al informe de correo)
...
- Operations: [`RUNBOOK.md`](RUNBOOK.md#m-eprun-path)
- Reporting: [`REPORTING.md`](REPORTING.md#m-eprep-mail), [`REPORT_SCOPE_CLIENT.md`](REPORT_SCOPE_CLIENT.md), [`reporting/OUTPUTS_OVERVIEW.md`](reporting/OUTPUTS_OVERVIEW.md)
...
- [`generated/DEEP_RESEARCH_RECONCILIATION.md`](generated/DEEP_RESEARCH_RECONCILIATION.md) (generated by [`scripts/leads/reconcile_deepresearch_50_with_current_cohort.py`](../scripts/leads/reconcile_deepresearch_50_with_current_cohort.py))
